    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <aside className="hidden md:flex w-64 flex-col bg-white shadow-md">
        ...
        <nav className="flex-1 p-4 space-y-2">
          <Link href="#notice-board" className="flex items-center space-x-2 p-2 hover:bg-gray-100 rounded-md">
            <Bell className="h-5 w-5" />
            <span>Notice Board</span>
          </Link>
          <Link href="#groups" className="flex items-center space-x-2 p-2 hover:bg-gray-100 rounded-md">
